...
print("  1. Décommenter la ligne : image = cv2.imread('votre_image.jpg', ...)")
print("  2. Remplacer 'votre_image.jpg' par le chemin de votre image")
print("  3. Commenter la ligne : image = create_sample_image()")